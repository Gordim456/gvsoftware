...
console.log('🎨 SOCIAL_ICONS: Component loading...');

const SocialIcons = () => {
  console.log('🎨 SOCIAL_ICONS: Component rendering...');
  ...
  try {
    ...
    console.error('❌ SOCIAL_ICONS: Error rendering component:', error);
    return (
      <div className="fixed right-4 top-1/2 transform -translate-y-1/2 bg-red-500 text-white p-2 rounded">
        Erro nos ícones sociais
      </div>
    );
  }
};

console.log('✅ SOCIAL_ICONS: Component defined successfully');
