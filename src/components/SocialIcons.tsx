...
const SocialIcons = () => {
  return (
    <div className="fixed right-4 top-1/2 transform -translate-y-1/2 flex flex-col gap-3 z-50">
      ...
      >
        <div className="bg-gradient-to-tr from-rose-500 via-purple-500 to-yellow-500 p-3 rounded-full shadow-lg hover:shadow-purple-500/30 transition-all duration-200 hover:scale-110">
      ...
      <div className="relative group cursor-not-allowed">
        ...
        <div className="bg-gradient-to-r from-gray-700 to-gray-800 p-3 rounded-full shadow-lg opacity-50">
          <TikTokIcon className="w-5 h-5 text-gray-400" strokeWidth={2.2} />
        </div>
      </div>
    </div>
  );
